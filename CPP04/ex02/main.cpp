...
/*   Updated: 2024/02/17 20:31:41 by razasharuku      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    {
        std::cout << "\033[1;35m" << "++++++++++++++++++ TEST 3 _END(Copy assignment check) ++++++++++++++++++++\n" << "\033[0m" << std::endl;
        // Animal animal;
        // これは抽象クラスになるので、エラーが出る→要はこれでインスタンスを作らないでねってこと
        // 純仮想関数のmakesoundを含んでいるから。
        std::cout << "\033[1;35m" << "++++++++++++++++++ TEST 3 _END(Copy assignment check) ++++++++++++++++++++\n" << "\033[0m" << std::endl;
